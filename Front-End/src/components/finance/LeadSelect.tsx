  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className={cn(
          "w-full flex items-center justify-between gap-2 rounded-md px-3 py-2 text-[13px] transition",
      ...
      >
        <span className="flex items-center gap-2 min-w-0">
          <span
            className={cn(
              "h-6 w-6 shrink-0 grid place-items-center rounded-md ring-1 ring-inset",
              value
                ? "bg-white/[0.05] text-slate-100 ring-white/[0.1]"
        ...
        <span className="flex items-center gap-1">
          {value ? (
            <span
              ...
              className="h-5 w-5 grid place-items-center rounded text-slate-500 hover:text-slate-200 hover:bg-white/[0.06] transition"
            >
      ...
      {open && (
        ...
        >
          <div className="p-2 border-b border-white/[0.05]">
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  "w-full bg-white/[0.02] border border-white/[0.08] rounded-md pl-8 pr-3 py-2 text-[13px] text-slate-100",
                  "placeholder:text-slate-600 focus:outline-none focus:border-white/[0.18] focus:bg-white/[0.03] transition",
                )}
              />
            </div>
          </div>
          ...
          >
            {isLoading ? (
              <div className="flex items-center justify-center gap-2 py-6 text-[11.5px] text-slate-500">
                <Loader2 className="h-3.5 w-3.5 animate-spin" /> Carregando leads…
              </div>
            ) : options.length === 0 ? (
              <div className="py-6 text-center text-[11.5px] text-slate-500">
              ...
              options.map((o, i) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={cn(
                        "h-7 w-7 shrink-0 grid place-items-center rounded-md text-[11px] font-semibold ring-1 ring-inset",
                        isSelected
          ...
          <div className="flex items-center justify-between border-t border-white/[0.05] px-3 py-2 text-[10px] tabular-nums text-slate-500">
            <span>
