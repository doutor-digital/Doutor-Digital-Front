    ...
    <div className="space-y-5">
      ...
      <div className={`grid grid-cols-1 gap-5 items-start ${
        ...
        <div className="min-w-0 space-y-4">
          ...
          {/* O cartão É a visão geral. Antes ele dividia a aba com quatro blocos de
              origem, um bloco de tempos e o log de interações — tudo repetido dentro
              dele, e a página inteira precisava de rolagem para juntar o que agora se
